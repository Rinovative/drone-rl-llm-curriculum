...
def test_line_task_reference_adds_default_start_and_final_holds() -> None:
    ...
    expected_tracking_phase_end_step = 51
    expected_total_reference_steps = 61
    ...
    assert reference.start_hold_sec == pytest.approx(2.0)
    ...
    assert reference.tracking_phase_start_time_sec == pytest.approx(2.0)
    ...
    assert reference.tracking_phase_end_time_sec == pytest.approx(5.0)
