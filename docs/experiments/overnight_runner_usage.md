...
LLM proposal repair treats hover and pure vertical as bootstrap/recovery tools, not ordinary repeated progression. After those early stages, it prefers short-line/line, angled or delayed altitude motion, polyline/zigzag/triangle/rectangle turns, circle/ellipse curves, and finally broad tracking. The proposal logs and run summary include repair metadata and coverage counts so hover/vertical loops are visible.
