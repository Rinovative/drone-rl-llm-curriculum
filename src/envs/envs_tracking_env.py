    ...
    def _make_info(
        ...
        return {
            ...
            **task_distribution_fields,
            ...
            "lower_start_height_enabled": bool(self.reference.task.get("lower_start_height_enabled", False)),
            ...
            "base_z_offset_m": self.reference.task.get("base_z_offset_m"),
            "base_z_offset_range_m": self.reference.task.get("base_z_offset_range_m"),
            ...
            "start_hold_reward_policy": self.reference.task.get("start_hold_reward_policy", "full_tracking_reward_active"),
