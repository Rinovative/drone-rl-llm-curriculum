...
KNOWN_TASK_DISTRIBUTION_CONFIGS = {
    ...
    "l_shape_bootstrap": "configs/tasks/task_distribution_polyline_bootstrap_medium.yaml",
    ...
    "rectangle_bootstrap": "configs/tasks/task_distribution_rectangle_bootstrap_medium.yaml",
    "circle_bootstrap": "configs/tasks/task_distribution_circle_bootstrap_medium.yaml",
    "ellipse_bootstrap": "configs/tasks/task_distribution_ellipse_bootstrap_medium.yaml",
...
def build_task_prompt_contract() -> str:
    ...
    return (
        ...
        "Concrete tasks should use standard-height references around 0.9-1.1m, randomized nearby starts, "
        "start_hold_enabled=true, start_hold_sec=1.0, "
        ...
        "For overnight screening prefer focused standard-height bootstraps; tracking_small is fallback/consolidation only, "
